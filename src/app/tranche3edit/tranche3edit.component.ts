...
@Component({
  selector: "app-tranche3edit",
  templateUrl: "./tranche3edit.component.html",
  styleUrls: ["./tranche3edit.component.css"]
})
export class Tranche3editComponent implements OnInit {
  ...
  approveData(form) {
    ...
    if (form.valid) {
      that.data.dateOfLastReviewControl = that.data.dateOfLastReviewControl?moment(that.data.dateOfLastReviewControl).format('DD/MM/YYYY'):"";
